...
def chat(system_prompt, your_next_message="Did that work?"):
    ...
    Returns:
        dict: A dictionary with the following keys:
            ...
            - "reason" (str or None): The reason provided by the user if specified, or None if no reason was given.
...
def ask_user_yes_no_get_reason(your_next_message="Did that work?") -> dict:
    ...
    **Steps**:
    ...
    - **If no reason is provided**: return JSON with reason as None, response, exit=False
