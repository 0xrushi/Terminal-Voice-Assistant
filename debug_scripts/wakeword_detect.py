...
def main():
    ...
    keyword_paths=['./Naomi_en_windows_v3_0_0.ppn']
...
# python wakeword_detect.py  --access_key <key here> --keyword_paths ./hey-nami_en_windows_v3_0_0.ppn  --audio_device_index 3
